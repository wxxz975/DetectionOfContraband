...
void OnnxModelAdapter::Yolov5::Preprocessing::Impl(const cv::Mat &image, 
    const std::vector<int64_t>& inputTensorShape, float* outBlob) 
{
...
void OnnxModelAdapter::Yolov5::Preprocessing::letterbox(const cv::Mat& image, cv::Mat& outImage,
