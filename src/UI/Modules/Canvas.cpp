...
void DcUI::Modules::Canvas::AddPanel(Panels::APanel & p_panel)
{
	m_panels.push_back(std::ref(p_panel));
}

void DcUI::Modules::Canvas::RemovePanel(Panels::APanel & p_panel)
{
...
void DcUI::Modules::Canvas::RemoveAllPanels()
{
	m_panels.clear();
}

void DcUI::Modules::Canvas::MakeDockspace(bool p_state)
{
	m_isDockspace = p_state;
}

bool DcUI::Modules::Canvas::IsDockspace() const
{
